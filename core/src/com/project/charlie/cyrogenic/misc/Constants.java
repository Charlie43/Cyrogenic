...
public class Constants {
    ...
    public static final String BACKGROUND_SPACE_IMAGE_PATH = "background.jpg";
    ...
    public static final String PLAYER_IMAGE_PATH = "plr_ship_trans.png";
    ...
    public static final String BLOCK_ASSET_PATH = "block.png";

    public static final String BOX_ASSET_ID = "box";
    public static final String BOX_ASSET_PATH = "boundingBox.png";

    public static final String BUTTONS_SKIN_PATH = "data/uiskin.json";


    public static final String ASTEROID_ASSET_ID = "asteroid";
    public static final String ASTEROID_IMAGE_PATH = "asteroid.png";
